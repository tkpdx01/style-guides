...
const contractTokens = new Set([
  ...
  "--sg-font-mono",
  "--sg-font-size-base",
  "--sg-font-size-control",
  "--sg-font-size-badge",
  "--sg-font-weight-control",
  "--sg-font-weight-badge",
  "--sg-line-height-base",
  "--sg-control-min-height",
  "--sg-control-gap",
  "--sg-control-padding-block",
  "--sg-control-padding-inline",
  "--sg-input-padding-block",
  "--sg-input-padding-inline",
  "--sg-badge-padding-block",
  "--sg-badge-padding-inline",
  "--sg-border-width",
  "--sg-focus-width",
  "--sg-focus-offset",
  "--sg-radius-control",
